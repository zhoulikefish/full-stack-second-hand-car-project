<template>
	<el-container >
      ...
      <!-- <div>
    <div v-bind="c_option1" class="chart-container"></div>
  </div> -->
  ...
  />
		...
		<el-row class="parallel-container" style="margin-top: 130px;">
		  <el-col :span="11" class="center-div">
			<el-form ref="ptsForm" :model="carInfo" style="margin-top: 20px; color: rgb(0, 0, 0)">
			  ...
			  <el-row>
				<el-col :span="12">
				  ...
				  <el-form-item style="line-height:20px; margin-top: 10px; margin-left: 10px;">
					<el-cascader v-model="品牌车型" :options="modelOptions" @change="handleChange($event, '品牌车型')" clearable
				...
				<el-col :span="8">
				  ...
				  <el-form-item style="line-height:20px; margin-top: 10px; margin-left: 10px;">
					<el-cascader v-model="上牌时间" :options="timeOptions" @change="handleChange($event, '上牌时间')" clearable
					  style="width: 200px;"></el-cascader>
			  ...
			  <el-row>
				<el-col :span="12">
				  ...
				  <el-form-item prop="location" style="line-height: 20px; margin-left: 10px;">
					<el-cascader v-model="地理位置" :options="locationOptions" @change="handleChange($event, '地理位置')" placeholder="请选择地理位置" clearable
					  style="width: 200px;"></el-cascader>
				  </el-form-item>
				...
				<el-col :span="12">
				  ...
				  <el-form-item prop="num_of_transfer" style="line-height: 20px; margin-left: 10px;">
					<el-select placeholder="请选择转手次数" style="width: 200px;">
			  ...
			  <el-row>
				<el-form-item>
				  <div class="button-div">
					<el-button @click="onSubmit('ptsForm')" style="background-color: #FFFFFF;  height: 50px; font-size: 18px; color: #1c1a1a; 
...
.overlay {
  ...
  width: 100%;
  height: 100%;
  background-image: url('../assets/image_pts.jpg');
  background-size: cover;
  background-repeat: repeat-y;
  opacity: 0.9; /* 可根据需要设置透明度 */
  z-index: -1;
}
...
export default {
  ...
  methods: {
    ...
    aaagenerateRandomData() {
      const data = [];
      for (let i = 0; i < 5; i++) {
        const randomValue = this.aaagenerateNormalDistribution(24, 40);
        data.push(randomValue);
      }
      this.aaaoption.xAxis.data = ['Point 1', 'Point 2', 'Point 3', 'Point 4', 'Point 5'];
      this.aaaoption.series[0].data = data;
    },
    aaagenerateNormalDistribution(mean, standardDeviation) {
      let u = 0,
        v = 0;
    ...
    aaainitChart() {
      ...
      chart.setOption(this.aaaoption);
    },
    //tag
    drawChart() {
      // 创建图表实例
    ...
    const data = [];
    for (let i = 0; i < 5; i++) {
      const randomValue = this.generateNormalDistribution(24, 40);
      data.push(randomValue);
    }
    return data;
    },
