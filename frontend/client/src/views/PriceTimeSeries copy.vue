<template>
  <el-container  >
    ...
    <el-main class="background-image">
            ...
            <el-row>
              ...
              <el-col :span="12">
                ...
                <el-form-item prop="numberOfTransfer" style="line-height: 20px; margin-left: 10px;">
                  <el-select v-model="carInfo.number_of_transfer" placeholder="请选择转手次数" clearable style="width: 200px;">
  ...
  methods: {
    ...
    async onSubmit() {
      ...
      try {
        ...
        const res = await this.$axios("/api/profiles");
        const now = new Date();
        const data = res.data;
